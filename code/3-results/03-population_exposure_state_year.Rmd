...
-   1984-1989: **`r d <- pop_exposed_state_year %>% filter(year %in% c(1984:1989)) %>% select(pop_exposed_n) %>% sum() / 6; round(d, digits = 0)`**
-   1990-1999: **`r d <- pop_exposed_state_year %>% filter(year %in% c(1990:1999)) %>% select(pop_exposed_n) %>% sum() / 10; round(d, digits = 0)`**
-   2000-2009: **`r d <- pop_exposed_state_year %>% filter(year %in% c(2000:2009)) %>% select(pop_exposed_n) %>% sum() / 10; round(d, digits = 0)`**
-   2010-2019: **`r d <- pop_exposed_state_year %>% filter(year %in% c(2010:2019)) %>% select(pop_exposed_n) %>% sum() / 10; round(d, digits = 0)`**
