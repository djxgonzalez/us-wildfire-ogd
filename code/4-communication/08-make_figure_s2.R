##============================================================================##
## 4.06 -  makes Figure S2 plots the top four wildfires with the most oil and gas 
...
# Figure S2a - East Amarillo Complex Fire - T - 2006
...
# Figure S2b - Loco-Healdton Fire - OK - 2009
...
# Figure S2c - Thomas Fire - CA - 2017
...
ggsave(filename = "figure_s2a.png", plot = figure_s2a, device = "png",
...
figure_s2b <- ggplot() +
  ...
  theme(legend.position = "none",
        panel.background = element_rect(fill = "white"))
figure_s2b
ggsave(filename = "figure_s2b.png", plot = figure_s2b, device = "png",
       height = 6, width = 6, path = "output/figures/components/")
...
figure_s2c <- ggplot() +
  ...
  theme(legend.position = "none",
        panel.background = element_rect(fill = "white"))
ggsave(filename = "figure_s2c.png", plot = figure_s2c, device = "png",
       height = 6, width = 6, path = "output/figures/components/")
...
figure_s2d <- ggplot() +
  ...
  theme(legend.position = "none",
        panel.background = element_rect(fill = "white"))
ggsave(filename = "figure_s2d.png", plot = figure_s2d, device = "png",
       height = 6, width = 6, path = "output/figures/components/")
